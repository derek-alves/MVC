    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="jumbotron servicos">
                <div class="container">
                    ...
                    <div class="card-deck">
                        <div class="card text-center anim_esq">
                        ...
                        <div class="card text-center anim_dir">
                            <div class="icon-row tamanh-icone ">
                                <span class="step size-96 text-danger">
            ...
            <div class="jumbotron video">
                <div class="container">
                    <h2 class="display-4 text-center anim_bottom" style="margin-bottom: 40px;"><?php echo $titulo_vi ?></h2>
                    <p class="lead text-center video-parag anim_bottom"><?php echo $descricao_vi?></p>
                    <div class="row justify-content-md-center video-cont">

                        <div class="col-12 col-md-8 anim_bottom">
