...
<main role="main">
        ...
        <div class="jumbotron blog">
          <div class="container">
            <h2 class="display-4 text-center art-titulo" style="margin-bottom:40px;">Blog</h2>
            ...
            <div class="row">
                ...
                <div class="row featurette">
                    <div class="col-md-7 order-md-2 blog-text anim_esq">
                      <a href="<?php echo URL . 'artigo/'. $slug ?>">
                          <h2 class="featurette-heading text-danger"><?php echo $titulo; ?></h2></a>
                    ...
                    <div class="col-md-5 order-md-1 anim_dir">
                      <a href="<?php echo URL . 'artigo/'. $slug ?>"><img class="featurette-image img-fluid mx-auto" src="<?php echo URL . 'assets/imagens/artigo/'. $id. '/'. $imagem;  ?> " alt="<?php echo $titulo; ?>">
                        </a>
                    </div>
                  </div>
        ...
        <footer class="footer bg-danger">
          <div class="container text-center">
            <span class="text-muted">@copyright derek.com</span>
          </div>
        </footer>
